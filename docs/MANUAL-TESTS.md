...
| CLI-10 | Snap discovery | Discover an installed Snap application. | Output uses real paths under `/snap/PACKAGE/REVISION`, never `/snap/bin/*`; supported results validate successfully. | | |
