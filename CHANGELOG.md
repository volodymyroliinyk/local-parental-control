...
- Releases are now created and published exclusively from the `main` branch.

- Added explicit per-user all-day schedules without weakening daily limits or mandatory breaks.
